...
<head>
    ...
    <title>
        Acea Agriculture by beyondbiashara & mwachsteve@gmail.com
    </title>
    <!--     Fonts and icons     -->
        ...
        <div class="sidenav-header">
            <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute start-0 top-0 d-none d-xl-none"
                ...
                <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
                    ...
                    <span class="ms-1 font-weight-bold text-white">Acea Agriculture Dashboard</span>
                </a>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('rtl') }}">
                        ...
                        <span class="nav-link-text me-1">Service Report</span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 ">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Service Report</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Service Report</h6>
                </nav>
